...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_services_category" AS ENUM('individual', 'relationship', 'group');
  CREATE TYPE "public"."enum_services_icon" AS ENUM('user', 'users', 'compass', 'smile');
  CREATE TYPE "public"."enum_bookings_type" AS ENUM('in-person', 'online-video');
  ...
  CREATE TABLE "services" (
  	...
  	"duration" varchar DEFAULT '50 mins' NOT NULL,
  	"price" varchar DEFAULT '$120' NOT NULL,
  	"icon" "enum_services_icon" DEFAULT 'user' NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "events" (
  	...
  	"location" varchar DEFAULT 'Mindfulness Sanctuary & Garden' NOT NULL,
